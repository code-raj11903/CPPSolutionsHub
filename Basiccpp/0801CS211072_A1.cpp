/*Programming Task #01 : Write a program for Matrix Algebra ( addition, subtraction,  determinant, 
multiplication, inverse, transpose, rank , eigen vectors, trace, matrix factorization 
(LU decomposition, Singular value decomposition) etc.) using the any coding style*/
